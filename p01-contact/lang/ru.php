...
'config_error_open' =>
'<b>Никак не открыть конфигурационный файл.</b>
Проверьте его существование и права доступа к нему :',

'config_error_modify' =>
'<b>Не удается модифицировать конфигурационный файл.</b>
...
'enable'     => 'Включено',
'enable_sub' =>
'Включить или выключить отправку е-mail сообщения (не скрывает контактную форму).',
...
'default_params_sub' =>
'Структура тегов формы. Используйте синтаксис описанный в документации.',
...
'checklists_sub' =>
'Черный список: значения, при которых отправка письма не произойдет.<br />
Белый список: значения, которые требуются для отправки письма.<br />
...
'debug'     => 'Режим отладки',
'debug_sub' =>
'Отключается отправка емайл сообщения, на экране отображается p01-contact структура данных,
и данные которые были бы посланы по электронной почте.',
